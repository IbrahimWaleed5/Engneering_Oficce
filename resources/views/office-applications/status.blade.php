                ...
                @else
                    @php
                        $statusData = match ($application->status) {
                            'approved' => [
                                ...
                                'description' => 'تم إنشاء المكتب، وهو الآن بانتظار دفع واعتماد الاشتراك الشهري بقيمة 1000 ريال سعودي.',
                    ...
                    <div class="grid gap-4 mt-8 text-right sm:grid-cols-2">
                        ...
                        <div class="p-4 border rounded-2xl border-white/10 bg-white/5">
                            ...
                            <p class="mt-2 font-black text-white">
                                {{ $application->updated_at?->format('Y-m-d H:i') }}
                            </p>
                        </div>
                    </div>
                    ...
                    @if ($application->status === 'approved')
                        <div class="p-5 mt-7 text-right border rounded-2xl {{ $statusData['box'] }}">
                            ...
                            <p class="mt-2 leading-7 text-green-100">
                                يجب رفع إيصال اشتراك المكتب بقيمة 1000 ريال سعودي، وبعد اعتماد الدفع يصبح المكتب فعالًا داخل النظام.
                            </p>
                        </div>
                    @endif
