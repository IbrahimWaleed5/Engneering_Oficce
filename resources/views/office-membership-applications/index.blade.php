            ...
            <div class="flex flex-col gap-4 mb-8 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <h1 class="mt-2 text-3xl font-black text-white">
                        طلبات الانضمام إلى {{ $office->name }}
                    </h1>

                    <p class="mt-3 leading-7 text-slate-400">
                        راجع طلبات المهندسين، وافتح تفاصيل كل طلب للاطلاع
                        على السيرة الذاتية والشهادة واتخاذ القرار.
                    </p>
                </div>
                                ...
                                <tr class="transition hover:bg-white/[0.03]">
                                    <td class="p-4">
                                        <div class="flex items-center gap-3">
                                            <div class="flex items-center justify-center flex-shrink-0 w-12 h-12 overflow-hidden border rounded-xl border-white/10 bg-slate-800">
                                                @if ($application->engineer?->profile_photo)
                                                    <img
                                                        src="{{ asset(
                                                            'storage/'
