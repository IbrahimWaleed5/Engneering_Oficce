<x-app-layout>
        ...
        <main class="min-h-screen works-main lg:mr-64">
            ...
            <div class="works-custom-scrollbar h-[calc(100vh-64px)] overflow-y-auto p-8 space-y-8">
                ...
                >
                    ...
                    <div
                        id="worksFilterPanel"
                        class="hidden border-b border-[#434655]/10 bg-[#131b2e]/70 px-8 py-5"
                    >
                        <div class="grid gap-4 md:grid-cols-[1fr_auto_auto] md:items-end">
                            <div>
                                <label
                                    for="worksStatusFilter"
                                    class="block mb-2 text-sm font-bold text-[#c3c6d7]"
                                >
                                    حالة العمل
                                </label>
                                ...
                                <select
                                    ...
                                    class="w-full rounded-lg border border-[#434655]/30 bg-[#2d3449] px-4 py-3 text-sm font-bold text-[#dae2fd] focus:ring-1 focus:ring-[#b4c5ff]"
                                >
                            ...
                            <button
                                id="resetWorksFilters"
                                type="button"
                                class="rounded-lg bg-[#2d3449] px-5 py-3 text-sm font-bold text-[#dae2fd] transition hover:bg-[#31394d]"
                            >
                                مسح الفلاتر
                            </button>
                            ...
                            <a
                                ...
                                class="rounded-lg border border-[#b4c5ff]/20 bg-[#b4c5ff]/10 px-5 py-3 text-center text-sm font-bold text-[#b4c5ff] transition hover:bg-[#b4c5ff]/20"
                            >
                                المكتبة العامة
                            </a>
                        </div>
                                    ...
                                    >
                                        ...
                                        <td class="px-8 py-4">
                                            <div class="flex items-center gap-2">
                                                ...
                                                @if (Route::has('admin.engineer-works.destroy'))
                                                    <form
                                                        method="POST"
                                                    ...
                                                    >
                                                        ...
                                                        <button
                                                            type="submit"
                                                            class="flex items-center justify-center transition rounded-lg w-9 h-9 text-rose-200 bg-rose-500/10 hover:bg-rose-500/20"
                                                            title="حذف نهائي"
                                                        >
                                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const toggleFilters = document.getElementById('toggleWorksFilters');
            const resetFilters = document.getElementById('resetWorksFilters');
            const exportButton = document.getElementById('exportWorksReport');
            ...
            exportButton?.addEventListener('click', function () {
                ...
                link.href = url;
                link.download = 'engineer-works-review.csv';
            ...
            document
                .querySelectorAll('[data-delete-work]')
                .forEach((form) => {
                    form.addEventListener('submit', function (event) {
                        const title =
                            form.dataset.workTitle || 'هذا العمل';

                        const confirmed = window.confirm(
                            `هل أنت متأكد من حذف ${title} نهائيًا؟`
                        );
            ...
            document
                .querySelectorAll(
                    'form[action*="approve"], #rejectForm'
                )
                .forEach((form) => {
