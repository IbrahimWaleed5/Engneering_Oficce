    ...
    @auth
        ...
        @php
            ...
            if (
                ...
                $moderationStats = [
                    'all_warnings' =>
                        \App\Models\UserWarning::query()->count(),
            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                @if ($actsAsCustomer)
                    ...
                    >
                        ...
                        >
                            <div
                                class="flex items-center justify-center w-12 h-12 mb-5 text-2xl rounded-xl bg-violet-600/20"
                            >
                                🤖
                            </div>
                            ...
                            <p class="text-sm leading-7 text-slate-400">
                                اسأل مساعد الوليد الهندسي أو اطلب التحويل إلى موظف الدعم.
                            </p>
                        </a>
                ...
                @elseif ($currentUser->role === 'admin')
                    ...
                    >
                        ...
                        >
                            ...
                            <p class="mt-2 text-sm leading-6 text-slate-400">
                                اسأل مساعد الوليد الهندسي واستكمل محادثة الدعم.
                            </p>
                        </a>
                ...
                @else
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        >
                            ...
                            <p class="mt-2 text-slate-400">
                                اسأل مساعد الوليد الهندسي أو استكمل محادثة الدعم.
                            </p>
                        </a>
                    </div>
