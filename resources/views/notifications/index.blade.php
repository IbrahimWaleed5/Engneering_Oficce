...
<head>
    ...
    <title>مركز الإشعارات | الوليد الهندسي</title>

    <link rel="preconnect" href="https://fonts.bunny.net">
    <link
        href="https://fonts.bunny.net/css?family=cairo:400,500,600,700,800&display=swap"
        rel="stylesheet"
    >
...
@php
    ...
    <style>
        /* إخفاء الـNav والـHeader الرئيسيين القادمين من x-app-layout */
body > div.min-h-screen > nav,
body > div.min-h-screen > header,
body > div.min-h-screen > div > nav,
body > div.min-h-screen > div > header,
body > div > nav:first-child,
body > div > header:first-child {
    display: none !important;
}

/* إزالة المسافة التي يتركها الـNav القديم */
